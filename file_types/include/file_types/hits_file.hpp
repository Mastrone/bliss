...
void write_scan_hits_to_file(scan scan_with_hits, std::string_view file_path, std::string format="", double max_drift_rate=0.0); // <--- NUOVO ARGOMENTO (con default vuoto per sicurezza)
